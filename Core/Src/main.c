...
/**
  ...
  *
  ******************************************************************************
  * ECET260 Lab06: accelerometer
  * Kipling W. Dickie (C0461847)
  * 10/19/2020
  *
  * Resources:
  * - ECET260_Lab06_Accelerometer_LabDoc.pdf
  * - ECET260_Lab06_Accelerometer_Walkhrough.pdf
  * - UM1472_STM32f407Disc1_UserManual.pdf
  * - LIS3DSH_Datasheet.pdf
  * - STM32F4-Discovery_BSP_User_Manual.chm
  * - GIT-to-Github.pdf
  *
  * Program Instructions:
  * - Using the STM32F407-Discovery1's on board accelerometer, plot the X, Y,
  *   and Z axis on the STM32Monitors chart (Display on default graph).
  * - Blink the orange LED at a 500ms rate.
  ******************************************************************************
  */
...
int main(void)
{
  ...
  void 		BSP_ACCELERO_GetXYZ(int16_t *pDataXYZ); // Get XYZ acceleration.
